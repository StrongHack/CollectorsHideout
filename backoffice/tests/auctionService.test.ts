...
test("createAuction should return false when auction doesn't exist", async () => {
...
test("updateAuction should return false when auction doesn't exist", async () => {
...
test("deleteAuction should return false when auction doesn't exist", async () => {
    const auctionId = "randomNonExistingId";
